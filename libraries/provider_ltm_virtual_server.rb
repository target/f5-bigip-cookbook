  ...
  class Provider
    ...
    class F5LtmVirtualServer < Chef::Provider
      ...
      def load_current_resource # rubocop:disable MethodLength
        ...
        @current_resource.translate_address(vs.translate_address ? 'STATE_ENABLED' : 'STATE_DISABLED')
        @current_resource.translate_port(vs.translate_port ? 'STATE_ENABLED' : 'STATE_DISABLED')
